...
[
	...
	["Mk6 Mortar", "B_Mortar_01_F", 3000000],
	["Mk6 Mortar", "O_Mortar_01_F", 3000000],
	["Mk6 Mortar", "I_Mortar_01_F", 3000000]
];
...
[
	...
	["MK17 Holosight (Black)", "optic_Holosight_blk_F", 300, "item"],
	["MK17 Holosight (Khaki)", "optic_Holosight_blk_F", 300, "item"],
	["MK17 Holosight  SMG (Black)", "optic_Holosight_smg_blk_F", 300, "item"],
...
[
	...
	["Skate Helmet", "H_Helmet_Skate", 75, "hat", "noDLC"],
	["Combat Helmet (Tropic)", "H_HelmetB_tna_F", 75, "hat", "noDLC"],
	["Protector Helmet (Green Hex)", "H_HelmetO_ghex_F", 75, "hat", "noDLC"],
	["Light Combat Helmet (Tropic)", "H_HelmetB_Light_tna_F", 75, "hat", "noDLC"],
	["Assassin Helmet (Green Hex)", "H_HelmetSpecO_ghex_F", 75, "hat", "noDLC"],
	["Crew Helmet (Green Hex)", "H_HelmetCrew_O_ghex_F", 75, "hat", "noDLC"]
	//["Special Purpose Helmet (Hex)", "H_HelmetO_ViperSP_hex_F", 550000, "hat", "noDLC"],
	//["Special Purpose Helmet (Green Hex)", "H_HelmetO_ViperSP_ghex_F", 550000, "hat", "noDLC"]
];
...
// apex
	...
	["Carier Rig(Green, No Flag)","V_PlateCarrier2_rgr_noflag_F", -1, "vest", "noDLC"] 
];
...
[
	...
	//APEX
	//["ENVG-II(Black)", "NVGogglesB_blk_F", 150, "nvg"],
	//["ENVG-II(Green)", "NVGogglesB_grn_F", 150, "nvg"],
	//["ENVG-II(Gray)", "NVGogglesB_gry_F", 150, "nvg"],
	["Laser Designator (Green Hex)", "Laserdesignator_02_ghex_F", 300, "binoc", "noDLC"],
	["Laser Designator (Khaki)", "Laserdesignator_01_khk_F", 300, "binoc", "noDLC"]
...
[
	...
	["Zamak Resupply", "I_Truck_02_ammo_F", 6000, "vehicle"],
	["Zamak Transport", "I_Truck_02_transport_F", 6500, "vehicle"],
	["Zamak Covered", "I_Truck_02_covered_F", 7500, "vehicle"],
	["Zamak Fuel", "I_Truck_02_fuel_F", 9000, "vehicle"],
	["Zamak Medical", "I_Truck_02_medical_F", 10000, "vehicle"],
	["Zamak Repair", "I_Truck_02_box_F", 25000, "vehicle"],

	["UGV Stomper (NATO)", "B_UGV_01_F", 62500, "vehicle"],
	["UGV Stomper RCWS (NATO)", "B_UGV_01_rcws_F", 70000, "vehicle"],
	["UGV Stomper (AAF)", "I_UGV_01_F", 62500, "vehicle"],
	["UGV Stomper RCWS (AAF)", "I_UGV_01_rcws_F", 70000, "vehicle"],
	["UGV Saif (CSAT)", "O_UGV_01_F", 62500, "vehicle"],
...
[
	...
	["Strider HMG", "I_MRAP_03_hmg_F", 35500, "vehicle"],
...
[
	["CRV-6e Bobcat (Resupply)", "B_APC_Tracked_01_CRV_F", 62500, "vehicle"],
	["IFV-6c Panther", "B_APC_Tracked_01_rcws_F", 67500, "vehicle"],
...
[
	...
	["PO-30 Orca (Armed, Black)", "O_Heli_Light_02_v2_F", 85000, "vehicle"], // Armed Ka-60 with orca paintjob
	...
	["AH-99 Blackfoot", "B_Heli_Attack_01_F", 160000, "vehicle"], // RAH-66 with gunner
	["Mi-48 Kajman", "O_Heli_Attack_02_F", 160000, "vehicle"], // Mi-28 with gunner
...
[
	...
	["V-44 X Blackfish (Infantry)", "B_T_VTOL_01_infantry_F", 180000, "vehicle"],
	["V-44 X Blackfish (Gunship)", "B_T_VTOL_01_armed_F", 200000, "vehicle"],
	["Y-32 Xi'an", "O_T_VTOL_02_infantry_F", 200000, "vehicle"],
	...
	["K40 Ababil-3 Missile UAV", "O_UAV_02_F", 120000, "vehicle"],
	["K40 Ababil-3 Bomber UAV", "O_UAV_02_CAS_F", 110000, "vehicle"],
	["K40 Ababil-3 Missile UAV", "I_UAV_02_F", 120000, "vehicle"],
	["K40 Ababil-3 Bomber UAV", "I_UAV_02_CAS_F", 110000, "vehicle"],

	["KH-3A Fenghuang UAV", "O_T_UAV_04_CAS_F", 120000, "vehicle"]
];
