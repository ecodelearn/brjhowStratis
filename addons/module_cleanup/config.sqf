...
pvpfw_cleanUp_abandonRadius = 180; // If no unit is closer than the specified distance, the removal countdown will start - tabareco - mudou 200 - 180
pvpfw_cleanup_abandondTimer = 150; // The vehicle will be removed after the specified time - tabareco - mudou 180 - 150
...
pvpfw_cleanUp_dontCleanUpAroundDistance = 450; // Dont clean if the vehicle is in this range of one of the above markers. - tabareco - mudou 500 - 450

//////////////////////////////
// Clean destroyed vehicles //
//////////////////////////////
pvpfw_cleanUp_vehicleRadius = 5; // Destroyed vehicles cleanup timer will start if no unit is closer than this  - tabareco - mudou 10 - 5
pvpfw_cleanUp_vehicleTimer = 150; // tabareco - mudou 300 - 150

//////////////////
// Clean bodies //
//////////////////
pvpfw_cleanUp_bodyTimer = 300; // Bodies will be removed after the specified amount of seconds - tabareco - mudou 600 - 300 
...
pvpfw_cleanUp_weaponHolderTimer = 150; // Weaponholders will be deleted after this time - tabareco - mudou 300 - 150
