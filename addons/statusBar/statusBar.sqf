...
disableSerialization;
	...
	while {true} do 
	{
		...
		_time = (round(180-(serverTime)/60));  //edit the '180' value (60*3=180) to change the countdown timer if your server restarts are shorter or longer than 3 hour intervals
		// tabareco modificado de 240 pra 180 para reset em 3 horas
		...
		switch(_minutes) do
	{
		...
		((uiNamespace getVariable "osefStatusBarAdmin")displayCtrl 55554)ctrlSetStructuredText parseText 
			...
			<t shadow='1' shadowColor='#000000' color='%10'><img size='1.0'  shadowColor='#000000' image='addons\statusBar\icons\money.paa' color='%10'/> $%4</t> 
			...
			<t shadow='1' shadowColor='#000000' color='%15'><img size='1.0'  shadowColor='#000000' image='addons\statusBar\icons\suatmm_icon.paa' color='%10'/> $%9</t> 
